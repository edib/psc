...
hst=$(hostname)
key="/psc/${cls}/psc/templates/pgbouncer-userlist.txt.ctpl" 
...
for hst in ${gate_hosts[@]};do
	...
	ssh $hst /var/lib/psc/scripts/postgres/render_template.sh $cls pgbouncer-userlist.txt.ctpl "/etc/pgbouncer/userlist.txt"
