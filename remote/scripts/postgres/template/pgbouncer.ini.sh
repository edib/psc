...
hst=$(hostname)
key="/psc/${cls}/psc/templates/pgbouncer.ini.ctpl" 
...
for hst in ${gate_hosts[@]};do
	...
	ssh $hst /var/lib/psc/scripts/postgres/render_template.sh $cls pgbouncer.ini.ctpl "/etc/pgbouncer/pgbouncer.ini"
done
